...
namespace Project2
{
    public class Parser
    {
        public string Parse(string filename)
        {
            ...
            Image<Bgr, Byte> img = new Image<Bgr, byte>(filename).Resize(400, 400, Emgu.CV.CvEnum.Inter.Linear, true);
            ...
            triangleRectangleImage.Save("triangles.png");
            #endregion
